        ...
        try {
            ...
            foreach($request->row as $key => $row){
                ...
                DB::insert(
                    ...
                    nup, tanggal_peroleh, merk_type, nilai_barang, jumlah, kondisi, kode_barang, status, lengkap)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, 0)
                    ...
                    $barang->nup, $barang->tanggal_peroleh, $barang->merk_type, $barang->nilai_barang, $barang->jumlah, $barang->kondisi, $barang->kode_barang, 1));
