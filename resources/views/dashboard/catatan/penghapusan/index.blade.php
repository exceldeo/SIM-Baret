...
<div class="content">
    <nav class="breadcrumb bg-white push">
        ...
        <a href="{{route('dashboard.catatan.penghapusan.index')}}" class="breadcrumb-item active">Catatan Penghapusan</a>
    </nav>
</div>
@endsection
@section('main')
    ...
    <div class="block">
        <div class="block-header block-header-default">
            <div class="row">
                ...
                <div class="font-size-lg font-w600">Daftar Catatan Penghapusan</div>
            </div>
