...
<div class="content">
    <nav class="breadcrumb bg-white push">
        ...
        <a href="{{route('dashboard.validasi.penghapusan.unit.index')}}" class="breadcrumb-item">Validasi Penghapusan</a>
...
<div class="content">
    ...
    <div class="block">
        <div class="block-header block-header-default">
            <div class="row">
                <a href="{{route('dashboard.validasi.penghapusan.unit.index')}}" id="arrow-back" style="padding: 0px 0px 0px 12px;">
    ...
    <div class="block">
        ...
        <form action="{{route('dashboard.validasi.penghapusan.unit.save')}}" method="post">
        @csrf
